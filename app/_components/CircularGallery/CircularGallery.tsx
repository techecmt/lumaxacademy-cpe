...
/**
 * Ported from React Bits' CircularGallery (JS + CSS variant). The internal
 * Title/Media/App classes glue together several generic ogl primitives
 * (Mesh/Program/Plane) whose types don't compose cleanly across this custom
 * wiring, so `any` is used deliberately for those internal fields instead of
 * fighting ogl's generics — the public component props remain fully typed.
 */
